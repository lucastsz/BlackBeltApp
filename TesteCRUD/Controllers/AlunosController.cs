...
namespace BlackBeltApp.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,id_usuario,id_faixa,telefone_aluno")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,id_usuario,id_faixa,telefone_aluno")] Aluno aluno)
        {
            if (id != aluno.Id)
            {
                return NotFound();
